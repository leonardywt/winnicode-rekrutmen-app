...
class HomeController extends Controller
{
  public function index()
  {
    ...
    $latestjobs = Pekerjaan::with(['tipePekerjaan', 'kategoriPekerjaan', 'deskripsiTambahanPekerjaan', 'user'])
      ->orderBy('created_at', 'desc')
      ->take(10)
      ->get();

    $categoryCounts = $jobs->flatMap(function ($job) {
      return $job->kategoriPekerjaan->pluck('kategori');
    })->countBy()
      ->toArray();

    // Define possible categories with unique routes or SVG data
    $categories = [
      'Design' => ['url' => '/design', 'svg' => '<svg class="stroke-[#4640DE] group-hover:stroke-white" width="48" height="48" viewBox="0 0 48 48" fill="none"
      ...
      'Sales' => ['url' => '/sales', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      'Marketing' => ['url' => '/marketing', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      'Finance' => ['url' => '/finance', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      'Technology' => ['url' => '/technology', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      'Engineering' => ['url' => '/engineering', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M20 40L28 8M36 16L44 24L36 32M12 32L4 24L12 16" class="stroke-[#4640DE] group-hover:stroke-white"
                stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
'],
      'Business' => ['url' => '/business', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
      ...
      'Human Resources' => ['url' => '/human-resources', 'svg' => '<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
