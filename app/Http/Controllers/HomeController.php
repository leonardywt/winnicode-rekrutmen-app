...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $categories = [
            'Design' => ['url' => '/design', 'svg' => '<svg class="group-hover:stroke-white" width="48" height="48" viewBox="0 0 48 48" fill="none"
...
'],
        ...
        return Inertia::render('homepage', ['jobs' => $jobs, 'categoryData' => $categoryData]);
    }
}
