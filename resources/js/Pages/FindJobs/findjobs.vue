    ...
    <div class="flex mx-auto px-20 py-8">
        ...
        <div class="w-[65%]">
            ...
            <div class="grid grid-cols-1 gap-y-4 my-4">
                <div class="flex flex-col w-[90%] border px-10 py-4 bg-white md:flex-row">
                    ...
                    <div class="px-4 flex flex-col justify-between leading-normal">
                        <h5 class="text-lg font-semibold tracking-tight text-gray-900">Ini judul
                        </h5>
                        <p class="mb-2 text-sm font-normal text-gray-700">Nama perusahaan.</p>
